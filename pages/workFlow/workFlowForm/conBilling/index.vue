		...
		<u-form :model="dataForm" :rules="rules" ref="dataForm" :errorType="['toast']" label-position="left"
			...
			<view class="jnpf-card">
				<u-form-item label="开票人" prop="drawer" v-if="judgeShow('drawer')" required>
					<u-input v-model="dataForm.drawer" placeholder="输入开票人"></u-input>
				</u-form-item>
				<u-form-item label="开票日期" prop="billDate" v-if="judgeShow('billDate')" required>
					<jnpf-date-time type="date" v-model="dataForm.billDate" placeholder="输入开票日期"></jnpf-date-time>
				</u-form-item>
				<u-form-item label="公司名称" prop="companyName" v-if="judgeShow('companyName')">
					<u-input v-model="dataForm.companyName" placeholder="输入公司名称"></u-input>
				</u-form-item>
				<u-form-item label="关联名称" prop="conName" v-if="judgeShow('conName')">
					<u-input v-model="dataForm.conName" placeholder="输入关联名称"></u-input>
				</u-form-item>
				<u-form-item label="开户银行" prop="bank" v-if="judgeShow('bank')">
					<u-input v-model="dataForm.bank" placeholder="输入开户银行"></u-input>
				</u-form-item>
				<u-form-item label="开户账号" prop="amount" v-if="judgeShow('amount')">
					<u-input v-model="dataForm.amount" placeholder="输入开户账号"></u-input>
				</u-form-item>
				
				<u-form-item label="开票金额" prop="billAmount" v-if="judgeShow('billAmount')">
					<u-input v-model="dataForm.billAmount" placeholder="输入开票金额"></u-input>
				</u-form-item>
				<u-form-item label="税号" prop="taxId" v-if="judgeShow('taxId')">
					<u-input v-model="dataForm.taxId" placeholder="输入税号"></u-input>
				</u-form-item>
				<u-form-item label="发票号" prop="invoiceId" v-if="judgeShow('invoiceId')">
					<u-input v-model="dataForm.invoiceId" placeholder="输入发票号"></u-input>
				</u-form-item>
				<u-form-item label="付款金额" prop="payAmount" v-if="judgeShow('payAmount')">
					<u-input v-model="dataForm.payAmount" placeholder="输入付款金额"></u-input>
				</u-form-item>
				<u-form-item label="发票地址" prop="invoAddress" v-if="judgeShow('invoAddress')">
					<u-input v-model="dataForm.invoAddress" placeholder="输入发票地址"></u-input>
				</u-form-item>
