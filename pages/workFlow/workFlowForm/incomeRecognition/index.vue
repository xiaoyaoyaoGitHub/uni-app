		...
		<u-form :model="dataForm" :rules="rules" ref="dataForm" :errorType="['toast']" label-position="left"
			...
			<view class="cudt-card">
				<u-form-item label="结算月份" prop="settlementMonth" v-if="judgeShow('settlementMonth')" required>
					<u-input v-model="dataForm.settlementMonth" placeholder="请输入结算月份"
						:disabled="judgeWrite('settlementMonth')"></u-input>
				</u-form-item>
				...
				<u-form-item label="合同总金额" prop="totalAmount" v-if="judgeShow('totalAmount')">
					<u-input v-model="dataForm.totalAmount" placeholder="请输入合同总金额" type="number"
						:disabled="judgeWrite('totalAmount')"></u-input>
				</u-form-item>
				<u-form-item label="到款银行" prop="moneyBank" v-if="judgeShow('moneyBank')" required>
					<u-input v-model="dataForm.moneyBank" placeholder="请输入到款银行" :disabled="judgeWrite('moneyBank')">
					</u-input>
				</u-form-item>
				<u-form-item label="到款金额" prop="actualAmount" v-if="judgeShow('actualAmount')">
					<u-input v-model="dataForm.actualAmount" placeholder="请输入到款金额" type="number"
						:disabled="judgeWrite('actualAmount')"></u-input>
				</u-form-item>
				<u-form-item label="到款日期" prop="paymentDate" v-if="judgeShow('paymentDate')" required>
					<cudt-date-time type="datetime" v-model="dataForm.paymentDate" placeholder="请输入到款日期"
						:disabled="judgeWrite('paymentDate')"></cudt-date-time>
				</u-form-item>
				<u-form-item label="联系人姓名" prop="contactName" v-if="judgeShow('contactName')" required>
					<u-input v-model="dataForm.contactName" placeholder="请输入联系人姓名"
						:disabled="judgeWrite('contactName')"></u-input>
				</u-form-item>
				<u-form-item label="联系电话" prop="contacPhone" v-if="judgeShow('contacPhone')" required>
					<u-input v-model="dataForm.contacPhone" placeholder="请输入联系电话" type="number"
						:disabled="judgeWrite('contacPhone')"></u-input>
				</u-form-item>
				<u-form-item label="联系QQ" prop="contactQQ" v-if="judgeShow('contactQQ')">
					<u-input v-model="dataForm.contactQQ" placeholder="请输入联系QQ" type="number"
						:disabled="judgeWrite('contactQQ')"></u-input>
				</u-form-item>
				<u-form-item label="未付金额" prop="unpaidAmount" v-if="judgeShow('unpaidAmount')">
					<u-input v-model="dataForm.unpaidAmount" placeholder="请输入未付金额" type="number"
						:disabled="judgeWrite('unpaidAmount')"></u-input>
				</u-form-item>
				<u-form-item label="已付金额" prop="amountPaid" v-if="judgeShow('amountPaid')">
					<u-input v-model="dataForm.amountPaid" placeholder="请输入已付金额" type="number"
