		...
		<u-form :model="dataForm" :rules="rules" ref="dataForm" :errorType="['toast']" label-position="left"
			...
			<view class="jnpf-card">
				...
				<u-form-item label="用车人员" prop="carMan" v-if="judgeShow('carMan')">
					<u-input v-model="dataForm.carMan" placeholder="请输入用车人员"></u-input>
				</u-form-item>
				<u-form-item label="用车时间" prop="startDate" v-if="judgeShow('startDate')" required>
					<jnpf-date-time type="datetime" v-model="dataForm.startDate" placeholder="请输入用车时间"></jnpf-date-time>
				</u-form-item>
				<u-form-item label="还车时间" prop="endDate" v-if="judgeShow('endDate')" required>
					<jnpf-date-time type="datetime" v-model="dataForm.endDate" placeholder="请输入还车时间"></jnpf-date-time>
				</u-form-item>
				...
				<u-form-item label="路费金额" prop="roadFee" v-if="judgeShow('roadFee')">
					<u-input v-model="dataForm.roadFee" placeholder="请输入路费金额" type="number"></u-input>
				</u-form-item>
				<u-form-item label="公里数" prop="kilometreNum" v-if="judgeShow('kilometreNum')">
					<u-input v-model="dataForm.kilometreNum" placeholder="请输入公里数"></u-input>
				</u-form-item>
				<u-form-item label="随行人数" prop="entourage" v-if="judgeShow('entourage')">
					<u-input v-model="dataForm.entourage" placeholder="请输入随行人数"></u-input>
				</u-form-item>
