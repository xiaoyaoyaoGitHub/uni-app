		...
		<u-form :model="dataForm" :rules="rules" ref="dataForm" :errorType="['toast']" label-position="left"
			...
			<view class="jnpf-card">
				...
				<u-form-item label="创建日期" prop="applyDate" v-if="judgeShow('applyDate')">
					<jnpf-date-time type="date" v-model="dataForm.applyDate" placeholder="请输入创建日期"
						:disabled="judgeWrite('applyDate')"></jnpf-date-time>
				</u-form-item>
				<u-form-item label="完成时间" prop="planEndTime" v-if="judgeShow('planEndTime')">
					<jnpf-date-time type="datetime" v-model="dataForm.planEndTime" placeholder="请输入完成时间"
						:disabled="judgeWrite('planEndTime')"></jnpf-date-time>
				</u-form-item>
