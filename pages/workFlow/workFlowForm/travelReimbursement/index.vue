		...
		<u-form :model="dataForm" :rules="rules" ref="dataForm" :errorType="['toast']" label-position="left"
			...
			<view class="jnpf-card">
				<u-form-item label="报销编号" prop="reimbursementId" v-if="judgeShow('reimbursementId')">
					<u-input v-model="dataForm.reimbursementId" placeholder="请输入报销编号"></u-input>
				</u-form-item>
				<u-form-item label="票据数" prop="billsNum" v-if="judgeShow('billsNum')">
					<u-input v-model="dataForm.billsNum" placeholder="请输入票据数"></u-input>
				</u-form-item>
				<u-form-item label="出差人员" prop="travelerUser" v-if="judgeShow('travelerUser')">
					<u-input v-model="dataForm.travelerUser" placeholder="请输入出差人员"></u-input>
				</u-form-item>
				<u-form-item label="出差任务" prop="businessMission" v-if="judgeShow('businessMission')" required>
					<u-input v-model="dataForm.businessMission" placeholder="请输入出差任务" type="textarea"></u-input>
				</u-form-item>
			</view>
			<view class="jnpf-card">
				<u-form-item label="出发日期" prop="setOutDate" v-if="judgeShow('setOutDate')" required>
					<jnpf-date-time type="date" v-model="dataForm.setOutDate" placeholder="请选择出发日期"></jnpf-date-time>
				</u-form-item>
				<u-form-item label="回程日期" prop="returnDate" v-if="judgeShow('returnDate')" required>
					<jnpf-date-time type="date" v-model="dataForm.returnDate" placeholder="请选择回程日期"></jnpf-date-time>
				</u-form-item>
				...
				<u-form-item label="车辆里程" prop="vehicleMileage" v-if="judgeShow('vehicleMileage')">
					<u-input v-model="dataForm.vehicleMileage" placeholder="请输入车辆里程"></u-input>
				</u-form-item>
			</view>
			<view class="jnpf-card">
				<u-form-item label="过路费" prop="roadFee" v-if="judgeShow('roadFee')">
					<u-input v-model="dataForm.roadFee" placeholder="请输入过路费" type="number"></u-input>
				</u-form-item>
				<u-form-item label="停车费" prop="parkingRate" v-if="judgeShow('parkingRate')">
					<u-input v-model="dataForm.parkingRate" placeholder="请输入停车费" type="number"></u-input>
				</u-form-item>
				<u-form-item label="故障报修费" prop="breakdownFee" v-if="judgeShow('breakdownFee')">
					<u-input v-model="dataForm.breakdownFee" placeholder="请输入故障报修费" type="number"></u-input>
				</u-form-item>
				<u-form-item label="机票费" prop="planeTicket" v-if="judgeShow('planeTicket')">
					<u-input v-model="dataForm.planeTicket" placeholder="请输入机票费" type="number"></u-input>
				</u-form-item>
				<u-form-item label="车船费" prop="fare" v-if="judgeShow('fare')">
					<u-input v-model="dataForm.fare" placeholder="请输入车船费" type="number"></u-input>
				</u-form-item>
				<u-form-item label="住宿费用" prop="getAccommodation" v-if="judgeShow('getAccommodation')">
					<u-input v-model="dataForm.getAccommodation" placeholder="请输入住宿费用" type="number"></u-input>
				</u-form-item>
				<u-form-item label="轨道交通费" prop="railTransit" v-if="judgeShow('railTransit')">
					<u-input v-model="dataForm.railTransit" placeholder="请输入轨道交通费" type="number"></u-input>
				</u-form-item>
				<u-form-item label="餐补费用" prop="mealAllowance" v-if="judgeShow('mealAllowance')">
					<u-input v-model="dataForm.mealAllowance" placeholder="请输入餐补费用" type="number"></u-input>
				</u-form-item>
				<u-form-item label="出差补助" prop="travelAllowance" v-if="judgeShow('travelAllowance')">
					<u-input v-model="dataForm.travelAllowance" placeholder="请输入出差补助" type="number"></u-input>
				</u-form-item>
			</view>
			<view class="jnpf-card">
				<u-form-item label="其他费用" prop="other" v-if="judgeShow('other')">
					<u-input v-model="dataForm.other" placeholder="请输入其他费用" type="number"></u-input>
				</u-form-item>
				<u-form-item label="总计费用" prop="total" v-if="judgeShow('total')">
					<u-input v-model="dataForm.total" placeholder="请输入总计费用" type="number"></u-input>
				</u-form-item>
				<u-form-item label="报销金额" prop="reimbursementAmount" v-if="judgeShow('reimbursementAmount')">
					<u-input v-model="dataForm.reimbursementAmount" placeholder="请输入总计费用" type="number"></u-input>
				</u-form-item>
				<u-form-item label="借款金额" prop="loanAmount" v-if="judgeShow('loanAmount')">
					<u-input v-model="dataForm.loanAmount" placeholder="请输入借款金额" type="number"></u-input>
				</u-form-item>
				<u-form-item label="补找金额" prop="sumOfMoney" v-if="judgeShow('sumOfMoney')">
					<u-input v-model="dataForm.sumOfMoney" placeholder="请输入补找金额" type="number"></u-input>
				</u-form-item>
			</view>
		</u-form>
	</view>
