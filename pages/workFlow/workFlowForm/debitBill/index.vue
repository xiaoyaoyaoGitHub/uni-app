		...
		<u-form :model="dataForm" :rules="rules" ref="dataForm" :errorType="['toast']" label-position="left"
			...
			<view class="jnpf-card">
				<u-form-item label="所属部门" prop="position" v-if="judgeShow('position')" required>
					<u-input v-model="dataForm.position" placeholder="输入所属部门"></u-input>
				</u-form-item>
				<u-form-item label="申请日期" prop="applyDate" v-if="judgeShow('applyDate')" required>
					<jnpf-date-time type="date" v-model="dataForm.applyDate" placeholder="输入申请日期" disabled></jnpf-date-time>
				</u-form-item>
				<u-form-item label="员工姓名" prop="staffName" v-if="judgeShow('staffName')">
					<u-input v-model="dataForm.staffName" placeholder="输入员工姓名" disabled></u-input>
				</u-form-item>
				<u-form-item label="员工职务" prop="staffPost" v-if="judgeShow('staffPost')">
					<u-input v-model="dataForm.staffPost" placeholder="输入员工职务"></u-input>
				</u-form-item>
				<u-form-item label="员工编码" prop="staffId" v-if="judgeShow('staffId')">
					<u-input v-model="dataForm.staffId" placeholder="输入员工编码"></u-input>
				</u-form-item>
			</view>
			<view class="jnpf-card">
				<u-form-item label="借款方式" prop="loanMode" v-if="judgeShow('loanMode')" required>
					<u-input v-model="dataForm.loanMode" placeholder="输入借款方式"></u-input>
				</u-form-item>
				<u-form-item label="转账账户" prop="transferAccount" v-if="judgeShow('transferAccount')">
					<u-input v-model="dataForm.transferAccount" placeholder="输入转账账户"></u-input>
				</u-form-item>
				...
				<u-form-item label="借支金额" prop="amountDebit" v-if="judgeShow('amountDebit')">
					<u-input v-model="dataForm.amountDebit" placeholder="输入借支金额"></u-input>
				</u-form-item>
				<u-form-item label="还款票据" prop="repaymentBill" v-if="judgeShow('repaymentBill')">
					<u-input v-model="dataForm.repaymentBill" placeholder="输入还款票据"></u-input>
				</u-form-item>
				...
				<u-form-item label="借款原因" prop="reason" v-if="judgeShow('reason')">
					<u-input v-model="dataForm.reason" placeholder="输入借款原因" type="textarea"></u-input>
				</u-form-item>
			</view>
		</u-form>
	</view>
