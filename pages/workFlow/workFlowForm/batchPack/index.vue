		...
		<u-form :model="dataForm" :rules="rules" ref="dataForm" :errorType="['toast']" label-position="left"
			...
			<view class="jnpf-card">
				<u-form-item label="产品名称" prop="productName" v-if="judgeShow('productName')">
					<u-input v-model="dataForm.productName" placeholder="输入产品名称"></u-input>
				</u-form-item>
				<u-form-item label="生产车间" prop="production" v-if="judgeShow('production')">
					<u-input v-model="dataForm.production" placeholder="输入生产车间"></u-input>
				</u-form-item>
				<u-form-item label="编制人员" prop="compactor" v-if="judgeShow('compactor')">
					<u-input v-model="dataForm.compactor" placeholder="输入编制人员"></u-input>
				</u-form-item>
				...
				<u-form-item label="产品规格" prop="standard" v-if="judgeShow('standard')">
					<u-input v-model="dataForm.standard" placeholder="输入产品规格"></u-input>
				</u-form-item>
				<u-form-item label="入库序号" prop="warehousNo" v-if="judgeShow('warehousNo')">
					<u-input v-model="dataForm.warehousNo" placeholder="输入入库序号"></u-input>
				</u-form-item>
				<u-form-item label="批产数量" prop="productionQuty" v-if="judgeShow('productionQuty')">
					<u-input v-model="dataForm.productionQuty" placeholder="输入批产数量"></u-input>
				</u-form-item>
				...
				<u-form-item label="工艺规程" prop="regulations" v-if="judgeShow('regulations')">
					<u-input v-model="dataForm.regulations" placeholder="输入工艺规程"></u-input>
				</u-form-item>
				<u-form-item label="包装规格" prop="packing" v-if="judgeShow('packing')">
					<u-input v-model="dataForm.packing" placeholder="输入包装规格"></u-input>
				</u-form-item>
