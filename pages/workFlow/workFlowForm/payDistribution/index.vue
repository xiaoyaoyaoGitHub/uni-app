		...
		<u-form :model="dataForm" :rules="rules" ref="dataForm" :errorType="['toast']" label-department="left"
			...
			<view class="jnpf-card">
				<u-form-item label="所属月份" prop="month" v-if="judgeShow('month')">
					<u-input v-model="dataForm.month" placeholder="请输入所属月份"></u-input>
				</u-form-item>
				<u-form-item label="发放单位" prop="issuingUnit" v-if="judgeShow('issuingUnit')">
					<u-input v-model="dataForm.issuingUnit" placeholder="请输入发放单位"></u-input>
				</u-form-item>
				...
				<u-form-item label="员工职位" prop="position" v-if="judgeShow('position')">
					<u-input v-model="dataForm.position" placeholder="请输入员工职位"></u-input>
				</u-form-item>
				<u-form-item label="出勤天数" prop="actualAttendance" v-if="judgeShow('actualAttendance')">
					<u-input v-model="dataForm.actualAttendance" placeholder="请输入出勤天数" type="number"></u-input>
				</u-form-item>
			</view>
			<u-form-item label="基本薪资" prop="baseSalary" v-if="judgeShow('baseSalary')">
				<u-input v-model="dataForm.baseSalary" placeholder="请输入基本薪资" type="number"></u-input>
			</u-form-item>
			<u-form-item label="员工津贴" prop="allowance" v-if="judgeShow('allowance')">
				<u-input v-model="dataForm.allowance" placeholder="请输入员工津贴" type="number"></u-input>
			</u-form-item>
			<u-form-item label="员工保险" prop="insurance" v-if="judgeShow('insurance')">
				<u-input v-model="dataForm.insurance" placeholder="请输入员工保险" type="number"></u-input>
			</u-form-item>
			<u-form-item label="所得税" prop="incomeTax" v-if="judgeShow('incomeTax')">
				<u-input v-model="dataForm.incomeTax" placeholder="请输入所得税" type="number"></u-input>
			</u-form-item>
			<u-form-item label="员工绩效" prop="performance" v-if="judgeShow('performance')">
				<u-input v-model="dataForm.performance" placeholder="请输入员工绩效" type="number"></u-input>
			</u-form-item>
			<u-form-item label="加班费用" prop="overtimePay" v-if="judgeShow('overtimePay')">
				<u-input v-model="dataForm.overtimePay" placeholder="请输入加班费用" type="number"></u-input>
			</u-form-item>
			<u-form-item label="应发工资" prop="grossPay" v-if="judgeShow('grossPay')">
				<u-input v-model="dataForm.grossPay" placeholder="请输入应发工资" type="number"></u-input>
			</u-form-item>
			<u-form-item label="实发工资" prop="payroll" v-if="judgeShow('payroll')">
				<u-input v-model="dataForm.payroll" placeholder="请输入实发工资" type="number"></u-input>
			</u-form-item>
